...
```
This dataset contains information on the NYC Transit - with respect to the entrance, exit, routes, lines and ADA compliance for each subway in the city. 
...
*   The originally wide dataset was changed into a long table where the umbrella variable "route_name" stores all the route numbers. 
