...
politicians who are demogratic or republican at any given time –\> these
variables included year, president of that year (democratic or
republican), governors, and senators. This cleaned dataset has 822
variabels and 11 observations.
...
representative measure of stock market as a whole. This dataset had two
variables: date and close (the closing values of the S\&P stock index on
the associated date), and 3 observations.
...
(%). The cleaned version of the dataset has 3 observations.
